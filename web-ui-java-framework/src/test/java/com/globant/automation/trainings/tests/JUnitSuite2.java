...
import com.globant.automation.trainings.locale.UiTexts;
...
public class JUnitSuite2 extends ParameterizedWebDriverTest {
    ...
    public void test1() throws Exception {
        ...
        List<String> results = home.search(UiTexts.Google.Something()).getResultsTexts();
